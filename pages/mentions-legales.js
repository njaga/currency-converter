...
export default function MentionsLegales() {
  return <>
    <Head>
      ...
      <meta name="description" content="Mentions légales, confidentialité et fonctionnement des données de Kiwango." />
