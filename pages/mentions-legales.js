...
export default function MentionsLegales() {
  return <>
    <SeoHead title="Mentions légales et confidentialité | Kiwango" description="Mentions légales, confidentialité, géolocalisation, sources des taux et fonctionnement hors connexion de Kiwango." path="/mentions-legales" />
