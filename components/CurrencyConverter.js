...
export default function CurrencyConverter() {
  ...
  const openPair = (from, to) => { setFromCurrency(from); setToCurrency(to); changeTab('converter'); };
